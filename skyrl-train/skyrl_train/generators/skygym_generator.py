...
class SkyGymGenerator(GeneratorInterface):
    def __init__(
        self,
        generator_cfg: DictConfig,
        skygym_cfg: DictConfig,
    ...
    async def agent_loop(
        ...
        env_config = self.skygym_cfg.get(env_class, DictConfig({}))
        env = skygym.make(env_class, env_config=env_config, extras=env_extras)
    ...
    async def generate_batched(
        ...
        for env_class, env_extra, prompt in zip(env_classes, env_extras, prompts):
            ...
            env_config = self.skygym_cfg.get(env_class, DictConfig({}))
            env = skygym.make(env_class, env_config=env_config, extras=env_extra)
