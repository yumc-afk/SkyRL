"""
uv run --isolated --extra dev pytest tests/cpu/skygym/test_sql.py
"""
...
def test_compute_score(mock_db_file, mock_sqlite_connection, step_1_output, step_2_output, ground_truth, expected):
    ...
    env = skygym.make("text2sql", env_config=DictConfig({"db_path": "/home/ray/default/sql_data"}), extras=extras)
